...
class VD16Reader(VDCommonMixin, SRUMarc21BibliographicalReader):
    ...
    CATALOG_URIREF = URIRef("https://edpop.hum.uu.nl/readers/vd16")
...
class VD17Reader(VDCommonMixin, SRUMarc21BibliographicalReader):
    ...
    sru_version = "1.1"
    LINK_FORMAT = "https://kxp.k10plus.de/DB=1.28/CMD?ACT=SRCHA&IKT=8079&TRM=%27{}%27"
    CATALOG_URIREF = URIRef("https://edpop.hum.uu.nl/readers/vd17")
...
class VD18Reader(VDCommonMixin, SRUMarc21BibliographicalReader):
    ...
    sru_version = "1.1"
    LINK_FORMAT = (
        "https://kxp.k10plus.de/DB=1.65/SET=1/TTL=1/CMD?ACT=SRCHA&"
        "IKT=1016&SRT=YOP&TRM={}&ADI_MAT=B&MATCFILTER=Y&MATCSET=Y&ADI_MAT=T&"
        "REC=*"
    )
    CATALOG_URIREF = URIRef("https://edpop.hum.uu.nl/readers/vd18")
    ...
    def _get_identifier(cls, record: Marc21Data):
        ...
        for field in fields024:
            if (
                "2" in field.subfields
                and "a" in field.subfields
                and field.subfields["2"] == "vd18"
            ):
...
class VDLiedReader(VDCommonMixin, SRUMarc21BibliographicalReader):
    ...
    CATALOG_URIREF = URIRef("https://edpop.hum.uu.nl/readers/vdlied")
