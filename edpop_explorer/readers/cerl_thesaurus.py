...
class CERLThesaurusReader(SRUReader):
    ...
    CATALOG_URIREF = URIRef("https://edpop.hum.uu.nl/readers/cerlthesaurus")
    IRI_PREFIX = "https://edpop.hum.uu.nl/readers/cerlthesaurus/"
    READERTYPE = BIOGRAPHICAL
    SHORT_NAME = "CERL Thesaurus"
    DESCRIPTION = (
        "The CERL Thesaurus file contains forms of imprint "
    ...
    @classmethod
    def _get_acceptable_names(cls, namelist: List[Dict[str, str]]) -> List[str]:
        names = []
